import { recommendSort } from "./Sorter"
...
export let recommend = function(camps: Array<any>){
    for(let camp of camps){
        let length = camp.comments.length
        let five: number = 0, four= 0, three = 0, two = 0, one = 0
        let fiveRatio: number = 0, fourRatio= 0, threeRatio = 0, twoRatio = 0, oneRatio = 0
        if(length == 0){
            camp.score = 0
            continue
        }
